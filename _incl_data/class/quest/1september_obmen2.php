<?
/*
	Сущность изворотливости Хаоса (Книга на +10 ловкости)
	Желтый, зеленый, фиолетовый - Сущность изворотливости Хаоса
	//
	4745 - красный
	4746 - синий
	4747 - голубой
...
if(isset($test['id'])) {
	...
	$pvr = array();
	$pvr['ch'] = 15; //шанс
	$pvr['tr'] = array( array(4748,1) , array(4749,1) , array(4750,1) );
