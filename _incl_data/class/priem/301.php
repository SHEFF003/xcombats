	...
	$fx_priem = function(  $id , $at , $uid, $j_id ) {
		...
		if( $a > 0 ) {
			...
			//
				...
				//1, time() );
				//
				$prv['text2'] = '{tm1} {u1} подвергся действию &quot;<b>Темное ранение</b>&quot; и восстановил здоровье. <font Color=#'.$pvr['color'].'><b>'.$pvr['hpSee'].'</b></font> ['.$pvr['hpNow'].'/'.$pvr['hpAll'].']';
				//
