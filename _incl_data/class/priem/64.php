...
if( isset($pr_momental_this)) {
	...
	unset( $pr_used_this );
				...
				//
				$btl->priemAddLogFast( $u->info['id'], $this->ue['id'], "<font color^^^^#".$pvr['color2'].">Тепло Жизни [9]</font>",
				...
				//
	//
	echo '<font color=red><b>Вы успешно использовали прием &quot;Тепло Жизни [9]&quot;</b></font>';
	//$this->addEffPr($pl,$id);
	$this->mintr($pl);
}
