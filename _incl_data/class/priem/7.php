			...
			while($j < count($at['p'][$a]['atack'])) {
				...
				$at['p'][$a]['atack'][$j][1] == 5 )) {
					if( $pvr['used'] == 0 && !isset($at['p'][$a]['priems']['kill'][$uid][$j_id]) ) {
						//
						$at['p'][$a]['atack'][$j]['yron']['y'] -= ceil($at['p'][$a]['atack'][$j]['yron']['y']/2);
						$at['p'][$a]['atack'][$j]['yron']['r'] += -(ceil($at['p'][$a]['atack'][$j]['yron']['r']/2));
						$at['p'][$a]['atack'][$j]['yron']['k'] -= ceil($at['p'][$a]['atack'][$j]['yron']['k']/2);
						$at['p'][$a]['atack'][$j]['yron']['m_k'] -= ceil($at['p'][$a]['atack'][$j]['yron']['m_k']/2);
						$at['p'][$a]['atack'][$j]['yron']['m_y'] -= ceil($at['p'][$a]['atack'][$j]['yron']['m_y']/2);
						//						
