...
/*
	Прием: Приказ слабости
	Весь урон занижен в 3 раза
*/
$pvr = array();
			...
			while($j < count($at['p'][$a]['atack'])) {
				...
				$at['p'][$a]['atack'][$j][1] == 5 )) {
					if( $pvr['used'] == 0 && !isset($at['p'][$a]['priems']['kill'][$uid][$j_id]) ) {
						//
						$at['p'][$a]['atack'][$j]['yron']['y'] = round(1+$at['p'][$a]['atack'][$j]['yron']['y']/3);
						$at['p'][$a]['atack'][$j]['yron']['r'] = round(1+$at['p'][$a]['atack'][$j]['yron']['r']/3);
						$at['p'][$a]['atack'][$j]['yron']['k'] = round(1+$at['p'][$a]['atack'][$j]['yron']['k']/3);
						$at['p'][$a]['atack'][$j]['yron']['m_y'] = round(1+$at['p'][$a]['atack'][$j]['yron']['m_y']/3);
						$at['p'][$a]['atack'][$j]['yron']['m_k'] = round(1+$at['p'][$a]['atack'][$j]['yron']['m_k']/3);
						//
