...
if($e['bm_a1']=='wpchr53' && $end > 0)
{
	...
	{	
		...
		if( !isset($pvr['test']['id']) ) {
			...
			( 22, '".$uid2."', 'Чары тупости 3', 'add_s5=-30', 0, 77, 0, '".$uid1."', 0, 'priem', 308, 'enhp_3_cointel3.gif', 1, 5, 'чарытупости3', 0, 0, '', 0, 0, 0, 1, 0);
			");
			//
			...
			$mas1['text'] = '{tm1} {u2} получил'.$sax.' магическое ослабление &quot;<b>'.$e['imposed_name'].'</b>&quot;. (Интеллект: -30 на 5 ходов)';	
			$this->add_log($mas1);
		}
	}
}
