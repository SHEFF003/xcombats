...
class OAuthFB {
    ...
    const URL_CALLBACK = 'http://xcombats.com/social.php?fbconnect'; //URL ¬ашего сайта, на который произойдет перенаправление 
    ...
    /**
     * ≈сли данных недостаточно, то посмотрите что можно ещЄ запросить по этой ссылке
