...
// выводим текст поверх картинки
  // imagettftext($img, 8, 0, 110, 52, imagecolorallocate($img,10,10,10), 'fonts/cour.ttf' , 'new.xcombats.com');
  imagettftext($img, 8, 0, 7, 50, imagecolorallocate($img,77,77,77), 'fonts/cour.ttf' , 'new.xcombats.com &copy; 2013-'.date('Y'));
