...
s+='<a href="javascript:void(0)" onclick="top.chat.addto(\''+login+'\',\'to\')">'+login+'</a>['+level+']<a href=http://xcombats.com/info/'+id+' target=_blank><IMG SRC=http://img.xcombats.com/i/inf.gif WIDTH=12 HEIGHT=11 ALT="Информация о персонаже"></a>';
...
<?					$data=mysql_query("SELECT `id`,`login`,`level`,`align`,`room`,`online`,`city`, `battle`,
					...
					FROM `users` WHERE `align`>1 AND `align`<2 AND `real` = 1  ORDER BY `align` DESC, `online` DESC;");
