                ...
                <table width="500" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <div style="position:relative; cursor: pointer;" id="ione">
                        ...
                        <div style="position: absolute; left: 53px; top: 47px; width: 122px; height: 31px; z-index: 90;"><img <? thisInfRm('1.180.0.16'); ?> onClick="location='main.php?loc=1.180.0.16';" src="http://img.xcombats.com/i/images/300x225/map_klub5-1.gif" width="123" height="30" class="aFilter" /></div>   
                        
                        <div style="position: absolute; left: 202px; top: 167px; width: 122px; height: 31px; z-index: 90;"><img <? thisInfRm('1.180.0.376'); ?> onClick="location='main.php?loc=1.180.0.376';" src="http://img.xcombats.com/i/images/300x225/map_zalu2.gif" width="122" height="31" class="aFilter" /></div>   
                        <div style="position: absolute; left: 264px; top: 44px; width: 122px; height: 31px; z-index: 90;"><img <? thisInfRm('1.180.0.375'); ?> onClick="location='main.php?loc=1.180.0.375';" src="http://img.xcombats.com/i/images/300x225/map_zalu1.gif" width="122" height="31" class="aFilter" /></div>   
