                ...
                <table width="500" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td>
                      ...
                      <img src="http://img.xcombats.com/city/capitalcity/<? echo $now; ?>/city_capres2.jpg" alt="" name="img_ione" width="500" height="268" border="1" id="img_ione"/>
                      ...
                      <div style="position: absolute; left: 372px; top: 129px; width: 73px; height: 47px; z-index: 91;"><img  <? thisInfRm('1.180.0.13'); ?> src="http://img.xcombats.com/city/capitalcity/day/euroshop.gif" width="78" height="63"  class="aFilter" /></div>
                      <div style="position: absolute; left: 277px; top: 121px; width: 73px; height: 47px; z-index: 90;"><img  <? thisInfRm('1.180.0.12'); ?> src="http://img.xcombats.com/city/capitalcity/day/bank.gif" width="106" height="73"  class="aFilter" /></div>
                      <div style="position: absolute; left: 179px; top: 13px; width: 73px; height: 47px; z-index: 92;"><img  <? thisInfRm('1.180.0.263'); ?> src="http://img.xcombats.com/city/capitalcity/day/1ubkill.gif" width="116" height="186"  class="aFilter" /></div>
                      <div style="position: absolute; left: 104px; top: 115px; width: 73px; height: 47px; z-index: 89;"><img  <? thisInfRm('1.180.0.349'); ?> src="http://img.xcombats.com/city/capitalcity/day/1ureg.gif" width="106" height="73"  class="aFilter" /></div>
                      <div style="position: absolute; left: 28px; top: 86px; width: 73px; height: 47px; z-index: 89;"><img  <? thisInfRm('1.180.0.214'); ?> src="http://img.xcombats.com/city/capitalcity/day/cp_hostel.gif" width="86" height="90"  class="aFilter" /></div>
                      <div style="position: absolute; left: 69px; top: 159px; width: 73px; height: 47px; z-index: 89;"><img  <? thisInfRm('1.180.0.212'); ?> src="http://img.xcombats.com/city/capitalcity/day/flower_shop.gif" width="74" height="68"  class="aFilter" /></div>
                        ...
                        <div style="position:absolute; left:446px; top:153px; width:30px; height:54px; z-index:94;"><img <? thisInfRm('1.180.0.213'); ?> src="http://img.xcombats.com/i/images/300x225/capital/2strelka.gif" width="30" height="54" class="aFilter" /></div>
        
                        <div style="position:absolute; left:16px; top:155px; width:30px; height:54px; z-index:910;"><img <? thisInfRm('1.180.0.9'); ?> src="http://img.xcombats.com/i/images/300x225/capital/3strelka.gif" width="30" height="53" class="aFilter" /></div>
                        <div id="snow"></div>
                        <? echo $goline; ?>
                      </div>
                    </td>
...
?>
        ...
        <span style="white-space:nowrap; padding-left:3px; padding-right:3px; height:10px"><img src="http://img.xcombats.com/i/move/links.gif" width="9" height="7" />&nbsp;<a href="#" class="menutop" <? thisInfRm('1.180.0.214'); ?>>Общежитие</a></span>
        <span style="white-space:nowrap; padding-left:3px; padding-right:3px; height:10px"><img src="http://img.xcombats.com/i/move/links.gif" width="9" height="7" />&nbsp;<a href="#" class="menutop" <? thisInfRm('1.180.0.12'); ?>>Банк</a></span>
        <span style="white-space:nowrap; padding-left:3px; padding-right:3px; height:10px"><img src="http://img.xcombats.com/i/move/links.gif" width="9" height="7" />&nbsp;<a href="#" class="menutop" <? thisInfRm('1.180.0.212'); ?>>Цветочный магазин</a></span>
        <span style="white-space:nowrap; padding-left:3px; padding-right:3px; height:10px"><img src="http://img.xcombats.com/i/move/links.gif" width="9" height="7" />&nbsp;<a href="#" class="menutop" <? thisInfRm('1.180.0.263'); ?>>Башня смерти</a></span>
        <span style="white-space:nowrap; padding-left:3px; padding-right:3px; height:10px"><img src="http://img.xcombats.com/i/move/links.gif" width="9" height="7" />&nbsp;<a href="#" class="menutop" <? thisInfRm('1.180.0.349'); ?>>Регистратура клана</a></span>
        <span style="white-space:nowrap; padding-left:3px; padding-right:3px; height:10px"><img src="http://img.xcombats.com/i/move/links.gif" width="9" height="7" />&nbsp;<a href="#" class="menutop" <? thisInfRm('1.180.0.213'); ?>>Торговая улица</a></span>
        <span style="white-space:nowrap; padding-left:3px; padding-right:3px; height:10px"><img src="http://img.xcombats.com/i/move/links.gif" width="9" height="7" />&nbsp;<a href="#" class="menutop" <? thisInfRm('1.180.0.13'); ?>>Магазин &quot;Березка&quot;</a></span>
        </div>
        <!-- -->
