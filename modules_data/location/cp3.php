                ...
                <table width="500" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td>
                      ...
                      <div style="position: absolute; left: 192px; top: 171px; width: 73px; height: 47px; z-index: 90;"><img  <? thisInfRm('1.180.0.406'); ?> src="http://img.xcombats.com/newcap/st4_b1.gif" width="90" height="47"  class="aFilter" /></div>
                      <div style="position: absolute; left: 69px; top: 143px; width: 73px; height: 47px; z-index: 89;"><img  <? thisInfRm('1.180.0.215'); ?> src="http://img.xcombats.com/city/capitalcity/day/cp_libshop.gif" width="53" height="48"  class="aFilter" /></div>
                      <div style="position: absolute; left: 112px; top: 95px; width: 73px; height: 47px; z-index: 88;"><img  <? thisInfRm('1.180.0.xx'); ?> src="http://img.xcombats.com/city/capitalcity/day/auction.gif" width="154" height="90"  class="aFilter" /></div>
                      <div style="position: absolute; left: 261px; top: 123px; width: 73px; height: 47px; z-index: 87;"><img  <? thisInfRm('1.180.0.216'); ?> src="http://img.xcombats.com/city/capitalcity/day/cp_zooshop.gif" width="56" height="61"  class="aFilter" /></div>
                      <div style="position: absolute; left: 313px; top: 109px; width: 73px; height: 47px; z-index: 88;"><img  <? thisInfRm('1.180.0.321'); ?> src="http://img.xcombats.com/city/capitalcity/day/cp_portal.gif" width="75" height="90"  class="aFilter" /></div>
                      <div style="position: absolute; left: 392px; top: 104px; width: 73px; height: 47px; z-index: 88;"><img  <? thisInfRm('1.180.0.421'); ?> src="http://img.xcombats.com/city/capitalcity/day/cp_deathroom.gif" width="94" height="91"  class="aFilter" /></div>
                        ...
                        <div style="position:absolute; left:446px; top:153px; width:30px; height:54px; z-index:94;"><img <? thisInfRm('1.180.0.x'); ?> src="http://img.xcombats.com/i/images/300x225/capital/2stop.gif" width="29" height="54" class="aFilter" /></div>
        
                        <div style="position:absolute; left:16px; top:155px; width:30px; height:54px; z-index:910;"><img <? thisInfRm('1.180.0.11'); ?> src="http://img.xcombats.com/i/images/300x225/capital/3strelka.gif" width="30" height="53" class="aFilter" /></div>
                        <div id="snow"></div>
                        <? echo $goline; ?>
                      </div>
                    </td>
...
?>
        ...
        <span style="white-space:nowrap; padding-left:3px; padding-right:3px; height:10px"><img src="http://img.xcombats.com/i/move/links.gif" width="9" height="7" />&nbsp;<a href="#" class="menutop" <? thisInfRm('1.180.0.11'); ?>>Страшилкина улица</a></span>
        <span style="white-space:nowrap; padding-left:3px; padding-right:3px; height:10px"><img src="http://img.xcombats.com/i/move/links.gif" width="9" height="7" />&nbsp;<a href="#" class="menutop" <? thisInfRm('1.180.0.215'); ?>>Книжный магазин</a></span>
        <span style="white-space:nowrap; padding-left:3px; padding-right:3px; height:10px"><img src="http://img.xcombats.com/i/move/links.gif" width="9" height="7" />&nbsp;<a href="#" class="menutop" <? thisInfRm('1.180.0.216'); ?>>Зоомагазин</a></span>
        <span style="white-space:nowrap; padding-left:3px; padding-right:3px; height:10px"><img src="http://img.xcombats.com/i/move/links.gif" width="9" height="7" />&nbsp;<a href="#" class="menutop" <? thisInfRm('1.180.0.321'); ?>>Магический портал</a></span>
        </div>
        <!-- -->
