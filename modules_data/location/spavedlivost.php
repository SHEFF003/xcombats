...
if($_GET['get']=='10'  && $is_eff[0]==0){
    if(mysql_query("UPDATE `users` SET `money`=`money`+'10' where `id`='".$user['id']."'") and
        mysql_query('INSERT INTO `eff_users` (
				...
				"397","'.$user['id'].'","Благословление Справедливости","add_exp=5|add_m10=2|add_m11=2|nofastfinisheff=1","100","'.time().'"
			)'));
    {
...
?>
            ...
            <center><img src="http://xcombats.com/i/statue/big1256_zspobic.jpg" ></center>
