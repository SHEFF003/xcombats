                ...
                <table width="500" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <div style="position:relative; cursor: pointer;" id="ione">
                        ...
                        <div style="position: absolute; left: 183px; top: 50px; width: 16px; height: 18px; z-index: 90;"><img src="http://img.xcombats.com/i/images/300x225/fl1.gif" width="16" height="18" title="Вы находитесь в '<? echo $u->room['name']; ?>'"  /></div>
                        <div style="position:absolute; left:354px; top:115px; width:120px; height:35px; z-index:90;"><img <? thisInfRm('2.180.0.240'); ?> onClick="location='main.php?loc=2.180.0.240';" class="aFilter" src="http://img.xcombats.com/i/images/300x225/map_halls.gif" width="120" height="35" /></div>
                        ...
                        <div style="position:absolute; left:393px; top:170px; width:100px; height:35px; z-index:90;"><img onclick="alert('Проход через залы');" src="http://img.xcombats.com/i/images/300x225/map_zalu7.gif" width="100" height="35" /></div> 
                        <? echo $goline; ?>
                        <div id="snow"></div>
                    </div>
                    </td>
