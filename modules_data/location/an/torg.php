...
<div style="position:absolute; left:118px; top:175px; width:101px; height:37px; z-index:90;"><img  <? thisInfRm('2.180.0.244'); ?> onclick="location='main.php?loc=2.180.0.244';" onmouseover="this.className='aFilterhover';" onmouseout="this.className='aFilter';" src="http://img.xcombats.com/i/images/300x225/map_sec3.gif" width="101" height="37"  class="aFilter"  /></div>
                      ...
                      <div style="position:absolute; left:23px; top:116px; width:120px; height:35px; z-index:90;"><img <? thisInfRm('2.180.0.259'); ?> onclick="location='main.php?loc=1.180.0.220';" onmouseover="this.className='aFilterhover';" onmouseout="this.className='aFilter';" src="http://img.xcombats.com/i/images/300x225/map_2stair.gif" width="120" height="35"  class="aFilter"  /></div>
