                ...
                <table width="500" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <div style="position:relative; cursor: pointer;" id="ione">
                        ...
                        <div style="position: absolute; left: 159px; top: 27px; width: 16px; height: 18px; z-index: 90;"><img src="http://img.xcombats.com/i/images/300x225/fl1.gif" width="16" height="18" title="Вы находитесь в '<? echo $u->room['name']; ?>'"  /></div>
                        <div style="position:absolute; left:354px; top:115px; width:120px; height:35px; z-index:90;"><img src="http://img.xcombats.com/i/images/300x225/map_halls.gif" <? thisInfRm('1.180.0.15'); ?> onClick="location='main.php?loc=1.180.0.16';" class="aFilter" width="120" height="35" /></div>
                        <div style="position: absolute; left: 53px; top: 47px; width: 122px; height: 31px; z-index: 90;"><img src="http://img.xcombats.com/i/images/300x225/map_klub5-1.gif" width="123" height="30" /></div>   
                        
                        <div style="position: absolute; left: 202px; top: 167px; width: 122px; height: 31px; z-index: 90;"><img <? thisInfRm('1.180.0.16'); ?> onClick="location='main.php?loc=1.180.0.16';" src="http://img.xcombats.com/i/images/300x225/map_zalu2.gif" width="122" height="31" class="aFilter" /></div>   
                        <div style="position: absolute; left: 264px; top: 44px; width: 122px; height: 31px; z-index: 90;"><img <? thisInfRm('1.180.0.16'); ?> onClick="location='main.php?loc=1.180.0.16';" src="http://img.xcombats.com/i/images/300x225/map_zalu1.gif" width="122" height="31" class="aFilter" /></div>   
                        
                      <div style="position:absolute; left:78px; top:24px; width:76px; height:18px; z-index:90;"><img src="http://img.xcombats.com/i/images/300x225/map_zalu6.gif" <? thisInfRm('1.180.0.0'); ?> onClick="location='main.php?loc=1.180.0.0';" width="76" height="18" class="aFilter"  /></div>	
                      ...
                      <div style="position:absolute; left:393px; top:170px; width:100px; height:35px; z-index:90;"><img <? thisInfRm('1.180.0.3'); ?> onClick="location='main.php?loc=1.180.0.3';" src="http://img.xcombats.com/i/images/300x225/map_zalu7.gif" width="100" height="35" class="aFilter" /></div> 
                        <? echo $goline; ?>
                        <div id="snow"></div>
                    </div>
                    </td>
