                ...
                <table width="500" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <div style="position:relative; cursor: pointer; width: 500;" id="ione"><img src="http://img.xcombats.com/i/images/300x225/club/navig.jpg" id="img_ione" width="500" height="240"  border="1"/>
                      ...
                      <div style="position:absolute; left:66px; top:114px; width:56px; height:13px; z-index:90;"><img   <? thisInfRm('1.180.0.15'); ?> onClick="location='main.php?loc=1.180.0.15';"  src="http://img.xcombats.com/i/images/300x225/map_klub1.gif" width="56" height="13"  class="aFilter" /></div>
                      <div style="position:absolute; left:216px; top:41px; width:58px; height:49px; z-index:90;"><img   <? thisInfRm('1.180.0.220'); ?> onClick="location='main.php?loc=1.180.0.220';"  src="http://img.xcombats.com/i/images/300x225/map_klub2.gif" width="58" height="49"  class="aFilter" /></div>
                      <div style="position:absolute; left:312px; top:168px; width:123px; height:31px; z-index:90;"><img <? thisInfRm('1.180.0.2'); ?> onClick="location='main.php?loc=1.180.0.2';" src="http://img.xcombats.com/i/images/300x225/map_klub3.gif" width="123" height="31" title="" class="aFilter" /></div>
                      <div style="position:absolute; left:59px; top:169px; width:123px; height:31px; z-index:90;"><img  <? thisInfRm('1.180.0.4'); ?> onClick="location='main.php?loc=1.180.0.4';"  src="http://img.xcombats.com/i/images/300x225/map_klub4.gif" width="123" height="31"  class="aFilter" /></div>
					  <div style="position:absolute; left:312px; top:48px; width:123px; height:30px; z-index:90;"><img  <? thisInfRm('1.180.0.5'); ?> onClick="location='main.php?loc=1.180.0.5';"  src="http://img.xcombats.com/i/images/300x225/map_klub5.gif" width="123" height="30"  class="aFilter"  /></div>
                      
                      <div style="position: absolute; left: 338px; top: 109px; width: 123px; height: 30px; z-index: 90;"><img  <? thisInfRm('1.180.0.222'); ?> onClick="location='main.php?loc=1.180.0.222';"  src="http://img.xcombats.com/i/images/300x225/map_sec3.gif" width="101" height="37"  class="aFilter"  /></div>
                                            
                      <div style="position:absolute; left:52px; top:47px; width:123px; height:30px; z-index:90;"><img <? thisInfRm('1.180.0.7'); ?> onClick="location='main.php?loc=1.180.0.7';" src="http://img.xcombats.com/i/images/300x225/map_klub6.gif" width="123" height="30"  class="aFilter" /></div>
					  <div style="position:absolute; left:196px; top:148px; width:103px; height:47px; z-index:90;"><img <? thisInfRm('1.180.0.9'); ?> onClick="location='main.php?loc=1.180.0.9';"  src="http://img.xcombats.com/i/images/300x225/map_klub7.gif" width="103" height="47"  class="aFilter" /></div>
					  <div id="snow"></div>
                      <? echo $goline; ?>
                    </div>
                    <?php } ?>
