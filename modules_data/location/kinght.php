...
<div style="position:absolute; left:118px; top:175px; width:101px; height:37px; z-index:90;"><img  onmouseover="this.className='aFilterhover';" onmouseout="this.className='aFilter';" src="http://img.xcombats.com/i/images/300x225/map_sec3.gif" width="101" height="37"  class="aFilter"  /></div>
					  ...
					  <div style="position:absolute; left:391px; top:120px; width:89px; height:32px; z-index:90;"><img  <? thisInfRm('1.180.0.223'); ?> onclick="location='main.php?loc=1.180.0.223';" onmouseover="this.className='aFilterhover';" onmouseout="this.className='aFilter';" src="http://img.xcombats.com/i/images/300x225/map_sec4.gif" width="89" height="32"  class="aFilter"  /></div>
                      <div id="snow"></div>
                      <? echo $goline; ?>
                    </div>
                    </td>
